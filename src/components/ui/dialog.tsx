      ...
      <DialogPrimitive.Overlay className="fixed inset-0 z-50 bg-black/80 overflow-y-auto overflow-x-hidden data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0">
        <div className="flex flex-col min-h-full items-center">
          ...
          <DialogPrimitive.Content
            ref={ref}
            className={cn(
              "relative z-50 grid w-full max-w-lg sm:max-w-[520px] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-t-[12px] sm:rounded-lg",
              className,
            )}
            style={{
